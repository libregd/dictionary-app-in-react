              ...
              <div className="fw-normal">
                ...
                <ul className="list-group ">
                  {partMean(name)[0].map(element => {
                    return (
                      <li className="list-group-item border-0 border-bottom"> {element}</li>
                    )
                  })}
                </ul>
                <h1 className="text-start my-3 text-capitalize fs-6 fw-bold">example</h1>
                <ul className="list-group ">
                ...
                <div className="row">
                  <div className="col">
                    <h1 className="text-start my-3 text-capitalize fs-6 fw-bold">antonyms</h1>
                    <ul className="list-group ">
                  ...
                  <div className="col">
                    <h1 className="text-start my-3 text-capitalize fs-6 fw-bold">Synonyms</h1>
                    <ul className="list-group ">
